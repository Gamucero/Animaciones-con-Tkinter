...
#................................... Global variables
RunAll=True
GetData=RunInter=False
#.................................. interaction functions
def StartStop():
    global RunInter
    RunInter= not RunInter
    if RunInter:
...
#.................................. derivatives-computing fucntion
def dfdt(y,t,params):
    xx,vx,yy,vy=y 
...
LabPar=[]
EntryPar=[]
ParList=['Length','Hooke','Mass','\u03B7','g','Ox','Oy','scale','Time step','\u03C4/ms']
nPar=len(ParList)
#.................................. Entries
for i in range(nVar):
...
while RunAll:
    ...
    #.................................. Draw pendulum
    canvas.delete(ALL)
    canvas.create_oval(Ox-scale*L,ch-Oy+scale*L,Ox+scale*L,ch-Oy-scale*L,outline='green',width=1)
    ...
    if length>=L:
        ...
        canvas.create_line(Ox,ch-Oy,Ox+scale*xx2,ch-Oy-scale*yy2,Ox+scale*xx,ch-Oy-scale*yy,fill='black')
    canvas.create_oval(Ox+scale*xx-rad,ch-Oy-scale*yy-rad,Ox+scale*xx+rad,ch-Oy-scale*yy+rad,fill=bColor)
    canvas.update()
    if RunInter:
    ...
    if tcount%10==0:
        ...
        tt0=tt0
    #.................................. Entries
    ElapsedIter=int((time.time()-StartInter)*1000.0)
    canvas.after(tau-ElapsedIter)
root.destroy()